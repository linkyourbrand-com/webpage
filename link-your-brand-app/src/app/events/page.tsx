...
<<<<<<< HEAD
const events = [
  { id: "q1", title: "Scaling Strategies Webinar", date: "Dec 10, 2025 at 10:00 AM EST", desc: "Advanced techniques for scaling ad spend and conversion rates before the holidays." },
  { id: "q2", title: "AI in E-commerce Workshop", date: "Jan 15, 2026 at 2:00 PM PST", desc: 'Implement "set-it and forget it" AI systems for customer service and inventory.' },
  { id: "q3", title: "Supply Chain Optimization", date: "Feb 28, 2026 at 1:00 PM GMT", desc: "Master international logistics and lower your fulfillment costs." },
  { id: "q4", title: "Scaling with TikTok Shop", date: "Mar 5, 2026 at 3:00 PM CST", desc: "How to use the fastest growing e-commerce channel for explosive growth and viral sales." },
  { id: "q5", title: "Automation & Outsourcing (The Mentor System)", date: "Apr 20, 2026 at 1:00 PM EST", desc: "Hiring VAs and setting up automations to reduce your daily work to just 2 hours." },
  { id: "q6", title: "Financial Review & Tax Strategy", date: "May 1, 2026 at 11:00 AM PST", desc: "Understanding P&L statements and legal tax deductions for e-commerce entrepreneurs." },
=======
...
>>>>>>> d3f46fcdbb84656ce56703cd186eca8ff570d19f
];
...
<<<<<<< HEAD
    events.forEach((event) => {
      // dynamically build URL per event
      const url = `/events/${event.id}/register`;
      generateQRCode(event.id, url);
    });
=======
    events.forEach((e) => generateQRCode(e.id, e.url));
>>>>>>> d3f46fcdbb84656ce56703cd186eca8ff570d19f
  }, []);
...
=======
            <button className="text-blue-700 underline mb-3">
              View Event Details
            </button>

            <p className="text-sm text-gray-500 mb-2">Scan to Register</p>
            <canvas id={event.id} />
>>>>>>> d3f46fcdbb84656ce56703cd186eca8ff570d19f
          </div>
        ))}
